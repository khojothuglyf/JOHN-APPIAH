...
export const PWA_BLOCK = `    <!-- PWA-META -->
    ...
    <meta name="application-name" content="TradeWide" />
    <link rel="apple-touch-icon" href="/icons/apple-touch-icon.png?v=ts-2" />
    <meta name="apple-mobile-web-app-capable" content="yes" />
    <meta name="apple-mobile-web-app-title" content="TradeWide" />
...
export function seoBlockFor(pagePath, siteUrl) {
  ...
  return `    <!-- SEO-META -->
    ...
    <meta property="og:title" content="TradeWide - Buy. Sell. Trade Worldwide." />
    <meta property="og:description" content="TradeWide is a global marketplace for buying and selling products." />
    <meta property="og:url" content="${url}" />
    <meta property="og:site_name" content="TradeWide" />`;
}
